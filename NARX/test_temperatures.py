...
CSV_NAME = 'daily-minimum-temperatures-in-me.csv'
COL_MAIN_VALUE = 'Daily minimum temperatures'
...
plt.savefig("temperatures.png", facecolor=fig.get_facecolor(), transparent=True)